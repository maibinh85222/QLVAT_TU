...
namespace QLVT
{
    public partial class XtraCTSLXuat : DevExpress.XtraReports.UI.XtraReport
    {
        private List<CTSLXuat> data;
        public XtraCTSLXuat(List<CTSLXuat> data)
        {
            InitializeComponent();
            this.data = data;
            CreateReport();
        ...
        private DetailReportBand CreateContainer(XRTable table,string date,int Amount,decimal TotalMoney)
        {
            ...
            footer.Controls.AddRange(new XRControl[] {
               new XRLabel
               {
                   ...
                   LocationF = new PointF(LocationF.X+50,LocationF.Y),
                   Font = new Font(Font.FontFamily,10,FontStyle.Bold)
                   
               },
               new XRLabel
               {
                   Text= string.Format("{0:n}", Convert.ToDecimal(Amount) ),
                   SizeF=new SizeF(100,30),
                   LocationF = new PointF(LocationF.X+150,LocationF.Y)
               },
               new XRLabel
               {
                   Text = "Tổng Tiền: ",
        ...
        private XRTable CreateTable(List<CTSLXuat> models)
        {
